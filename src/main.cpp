...
int main() {
  ...
  //set initial lane and reference velocity
  double ref_velocity = 0.;
  int lane = 1;
  double speed_limit = 49.5;
  //double speed_limit = 120.0; // just for fun - the car does pretty well actually ;)

  h.onMessage([&ref_velocity, &lane, &speed_limit,  &map_waypoints_x,&map_waypoints_y,&map_waypoints_s,&map_waypoints_dx,&map_waypoints_dy](uWS::WebSocket<uWS::SERVER> ws, char *data, size_t length,
                     uWS::OpCode opCode) {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            if (car_speed == 0) {
              ...
              cout << "car_s:" << car_s << endl; //longitudinal motion
            }
            ...
            /*
            * Avoid collision with cars in our lane
            */
            if(prev_path_size > 0) {
              car_s = end_path_s;
            }
            ...
            for(int i=0; i<sensor_fusion.size(); i++) {
              ...
              bool gap_within_threshold = (other_car_s - car_s < threshold_front && car_ahead);

              cout << "gap_within_threshold: " << gap_within_threshold << endl;

              // remember: lane is 4m wide
            ...
            */
            ...
            // construct new path and add to current path
            ...
            */
            ...
            /*
            * Add each point we have on the spline to next_x_vals and next_y_vals
            */
            ...
            for(int i=0; i<path_size - points_to_add; i++) {
              ...
              // convert coords from car's frame to ref
